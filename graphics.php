...
<section class="bg-dark-blue py-5" id="welcome">  
  ...
  <div class="container">
        <style>
          .carouselGalleryControls .carousel-inner>.carousel-item>img {
...
<div class="fluid container">    
  <div class="heading">
    <h1 style="color:rgb(54, 56, 168);">
      Our Graphics Design work
    </h1>
    </div>
    ...
    <div class="tab-content my-5">
          ...
          <!-- control button-->
        <div class="tab-pane fade show in active" id="event1" role="tabevent">
          ...
          <!-- Slides -->
            ...
            <div class="row">
              <div class="col-10" style="margin-left:120px">
                <div id="carouselExampleControls1" class="carousel slide carouselGalleryControls" data-ride="carousel">
                  <div class="carousel-inner" style="border-color: rgb(96, 105, 233);" >
                  <div class="carousel-item active">
                      <img class="d-block w-100 "src="https://raw.githubusercontent.com/spadeems/web/master/img/graphics/1.jpeg"  class = " img-fluid"  alt="Graphics Design 1">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src = "https://raw.githubusercontent.com/spadeems/web/master/img/graphics/2.jpeg"  class = " img-fluid" alt="Graphics Design 2">
                    </div>
                    
                    <div class="carousel-item">
                      <img class="d-block w-100" src = "https://raw.githubusercontent.com/spadeems/web/master/img/graphics/3.jpeg"  class = " img-fluid"alt="Graphics Design 3">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100"  src = "https://raw.githubusercontent.com/spadeems/web/master/img/graphics/4.jpeg"  class = " img-fluid"alt="Graphics Design 4">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src = "https://raw.githubusercontent.com/spadeems/web/master/img/graphics/5.jpeg"  class = " img-fluid"  alt="Graphics Design 5">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100 "src="https://raw.githubusercontent.com/spadeems/web/master/img/graphics/6.jpeg"  class = " img-fluid"  alt="Graphics Design 6">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src = "https://raw.githubusercontent.com/spadeems/web/master/img/graphics/7.jpeg"  class = " img-fluid" alt="Graphics Design 7">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100"  src = "https://raw.githubusercontent.com/spadeems/web/master/img/graphics/8.jpeg"  class = " img-fluid"  alt="Graphics Design 8">
                    </div>
...
<!---->
  ...
  <script>
    $(document).ready(function() {
      $("#basicExampleNav .nav-link:contains(Gallery)").addClass("active");
    });
  </script>
</body>
</html>
