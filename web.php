...
<section class="bg-dark-blue py-5" id="welcome">  
...
<!-- Start -->
  <div class="fluid container text-center">
    <div class="heading">
    <h1 class="white-text"><b>Our Websites</b></h1>
    </div>
    <hr style="background-color:white; width:80%; transform: translateX(15%);">
    <span style="font-size: large;">
    
      <h3 style = " color: #a9a9aa" ><b>1. Gita and Vedant<b></h3>
   
    </span>
    <br>
    <img src="https://raw.githubusercontent.com/spadeems/web/master/img/achievements/img/1.png" class = " img-fluid" alt="" widhth="736" height="457">
  <br>
  <br>
  <br>
  <p>
  
      <button  class="button"><a href="https://gitaandvedant.spadeems.com/"><span><b>Visit here<b></a></span></button>
...
<span style="font-size: large;">
    ...
    <h3 style = " color: #a9a9aa" ><b>2. SpadeEMS<b></h3>
 
  </span>
  <br>
</p>
  <img src="https://raw.githubusercontent.com/spadeems/web/master/img/achievements/img/3.png"  class = " img-fluid" alt="" widhth="736" height="457">
  <br>
  <br>
  <br>
  <p>
    
      <button  class="button"><a href="https://spadeems.com/"><span><b>Visit here<b></a></span></button>
  ...
  <p><span style="font-size: large;">
    ...
    <h3 style = " color: #a9a9aa" ><b>3. Beingpreneur<b></h3>
 
  </span>
  <br>
  </p>
  <img src="https://raw.githubusercontent.com/spadeems/web/master/img/achievements/img/5.png"  class = " img-fluid" alt="" widhth="736" height="457">
  <br>
  <br>
  <br>
  <p>
     
      <button  class="button"><a href="https://beingpreneur.com/"><span><b>Visit here<b></a></span></button>
...
<p>
  <span style="font-size: large;">
    ...
    <h3 style = " color: #a9a9aa" ><b>4. Techbizo.tech<b></h3>
 
  </span>
  <br>
  </p>
  <img src="https://raw.githubusercontent.com/spadeems/web/master/img/achievements/img/6.png"  class = " img-fluid" alt="" widhth="736" height="457">
  <br>
  <br>
  <br>
  <p>
     
      <button  class="button"><a href="https://techbizo.tech/"><span><b>Visit here<b></a></span></button>
  ...
  <span style="font-size: large;">
    ...
    <h3 style = " color: #a9a9aa" ><b>5. SpadeLPU<b></h3>
 
  </span>
  <br>
  </p>
  <img src="https://raw.githubusercontent.com/spadeems/web/master/img/achievements/img/2.png"  class = " img-fluid" alt="" widhth="736" height="457">
  <br>
  <br>
  <br>
  <p>
     
      <button  class="button"><a href="https://spadelpu.com/"><span><b>Visit here<b></span></a></button>
...
<p>
  <span style="font-size: large;">
    ...
    <h3 style = " color: #a9a9aa" ><b>6. RaginiDesigner<b></h3>
 
  </span>
  <br>
  </p>
  <img src="https://raw.githubusercontent.com/spadeems/web/master/img/achievements/img/55.png"  class = "img-fluid" alt="RaginiDesigner" widhth="736" height="457">
  <br>
  <br>
  <br>
  <p>
     
      <button  class="button"><a href="http://raginidesigner.me/"><span><b>Visit here<b></span></a></button>
