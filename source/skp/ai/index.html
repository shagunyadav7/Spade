...
<head>
    ...
    <meta property="og:image" content="https://spadeems.com/img/favicon.png">
    <meta name="twitter:image" content="https://spadeems.com/img/favicon.png">
    <link rel="canonical" href="https://spadeems.com/ai">
    <meta property="og:title" content="SPADE EMS">
    <meta property="og:url" content="https://spadeems.com/ai">
    ...
    <!--Title-->
    <title>Spade Event Management Services | AI</title>
        <style type="text/css">
            body, html
            {
    ...
    <body>
        <div id="content">
            <iframe width="100%" height="100%" frameborder="0" src="https://skp-ai.herokuapp.com/" />
        </div>
    </body>
</html>
