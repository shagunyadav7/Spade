...
<div class="header_top" id="home">
				...
				<nav class="navbar navbar-expand-lg navbar bg-light fixed-top">
					<button class="navbar-toggler navbar-toggler-left ml-auto" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
				 ...
				 <div>  
				   <a class="navbar-brand" href="index.php">
						<img class="logo" src="images/brand-logo-white.png", alt="logo",height=200 , width = 150>
				   </a>
		...
		<!-- <div class="top-bar_sub_w3layouts container-fluid">
			...
			<div class="row">
				...
				<i class="fab fa-linode fa-spin" style="font-size:30px"></i>BLOG</a>
				</div>
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<div class="banner" style="background-image: url(images/banner4.jpg);"></div>"
			<!-- <img class="d-block w-100" src="..." alt="First slide"> -->
				<div class="carousel-caption">
					<h2 class="animated bounceInRight" style="animation-delay: 1s">We are Creative</h2>
					<h3 class="animated slideInRight" style="animation-delay: 1.5s">Create the lifestyle
																					you deserve</h3>
					<p><a href="#">Contact us</a></p>
				</div>
			</div>
    <div class="item">
		<div class="banner" style= "background-image: url(images/banner1.jpg);"></div>"
	  <!-- <img class="d-block w-100" src="..." alt="First slide"> -->
	    <div class="carousel-caption">
			<h3 class="animated slideInRight" style="animation-delay: 1s">Engaging Purposeful
					and Creative></h3>
			<!-- <p><a href="#">Contact us</a><p> -->
		</div>
	</div>
	...
	<div class="item">
		<div class="banner" style="background-image: url(images/banner3.jpg);"></div>"
	  <!-- <img class="d-block w-100" src="..." alt="First slide"> -->
	    <div class="carousel-caption">
			<h3  class="animated bounceInRight" style="animation-delay: 1s">Engaging Purposeful
					and Creative></h3>
			<!-- <p><a href="#">Contact us</a><p> -->
		</div>
	</div>
